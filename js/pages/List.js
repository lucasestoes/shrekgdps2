  ...
  template: `
    ...
    <main v-else class="page-list">
      ...
      <div class="meta-container">
        ...
        <p>Alternating levels will not be allowed on the list as a recent submission or record, exception being that you're allowed to alternate for only levels, such as "Wave consistency inv", "Scorpion", "DIAMOND BLADE ENDx50" and "Free for Dastinity".</p>
